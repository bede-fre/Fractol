...
/*   Updated: 2018/03/20 10:39:54 by bede-fre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_zoom2(t_values *val, int x, int y, int mouse)
{
	...
	m_i = (double)y / (val->draw.l_win / (val->fct2.y2 - val->fct2.y1))
		+ val->fct2.y1;
	val->fct2.x1 = ft_mapping2(m_r, val->fct2.x1, mapping, mouse);
	val->fct2.x2 = ft_mapping2(m_r, val->fct2.x2, mapping, mouse);
	val->fct2.y1 = ft_mapping2(m_i, val->fct2.y1, mapping, mouse);
	val->fct2.y2 = ft_mapping2(m_i, val->fct2.y2, mapping, mouse);
}
