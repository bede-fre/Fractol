...
/*   Updated: 2018/03/19 17:26:35 by bede-fre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static void	ft_init_val2_julia2(t_values *val)
{
	val->fract2.i = -1.0;
	val->fract2.z_r = (val->fract2.x / val->draw.zoom2) + val->fract2.x1;
	val->fract2.z_i = (val->fract2.y / val->draw.zoom2) + val->fract2.y1;
}
